...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine("\nWrite seeds to master-seed.json file");
        rnd.WriteMasterStream();


        Console.WriteLine("\nRead seeds from my-seeds.json file");
        try
        {
            var rndMySeeds = new csSeedGenerator("my-seeds.json");

            Console.WriteLine("Random Names using my-seeds.json file");
        ...
        {
            Console.WriteLine("Could not read seeds from my-seeds.json file");
